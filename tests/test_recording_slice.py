...
def test_a_marker_dates_the_track_start():
    assert _m(1000.0, offset=30.0).start_estimate == 970.0
...
def test_one_bad_offset_does_not_drag_the_start():
    ...
    assert seg.start_wall == 970.0              # the mean would be ~1008
